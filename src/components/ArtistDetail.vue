<template>
  <div v-if="artistData" class="flex flex-col h-full">
    ...
    <div class="flex gap-6 p-6 pb-4 flex-shrink-0 items-end">
      <div
        class="w-48 h-48 rounded-lg bg-elevated-hover flex items-center justify-center flex-shrink-0"
      >
        <Users class="w-16 h-16 text-muted-foreground" />
      </div>
      <div class="flex flex-col justify-end gap-2 min-w-0">
        <p class="text-caption text-muted-foreground uppercase tracking-wider">艺术家</p>
...
import { Play, Users } from "lucide-vue-next";
